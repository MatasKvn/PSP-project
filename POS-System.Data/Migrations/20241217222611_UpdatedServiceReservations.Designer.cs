...
namespace POS_System.Data.Migrations
{
    ...
    [Migration("20241217222611_UpdatedServiceReservations")]
    partial class UpdatedServiceReservations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("POS_System.Domain.Entities.ItemDiscount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ItemDiscountId = 2,
                            Value = 15,
                            Version = new DateTime(2024, 12, 17, 22, 26, 10, 825, DateTimeKind.Utc).AddTicks(4224)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Value = 500,
                            Version = new DateTime(2024, 12, 17, 22, 26, 10, 825, DateTimeKind.Utc).AddTicks(4226)
                        },
                        new
                        {
                            Id = 4,
            ...
            modelBuilder.Entity("POS_System.Domain.Entities.TimeSlot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeVersionId = 1,
                            IsAvailable = true,
                            StartTime = new DateTime(2024, 12, 17, 22, 26, 10, 825, DateTimeKind.Utc).AddTicks(4188)
                        },
                        new
                        {
                            Id = 2,
                            EmployeeVersionId = 1,
                            IsAvailable = true,
                            StartTime = new DateTime(2024, 12, 17, 22, 26, 10, 825, DateTimeKind.Utc).AddTicks(4190)
                        },
                        new
                        {
                            Id = 3,
                            EmployeeVersionId = 2,
                            IsAvailable = false,
                            StartTime = new DateTime(2024, 12, 17, 22, 26, 10, 825, DateTimeKind.Utc).AddTicks(4191)
                        },
                        new
                        {
                            Id = 4,
                            EmployeeVersionId = 3,
                            IsAvailable = true,
                            StartTime = new DateTime(2024, 12, 17, 22, 26, 10, 825, DateTimeKind.Utc).AddTicks(4192)
                        });
                });
