...
namespace POS_System.Data.Migrations
{
    ...
    [Migration("20241217190835_UpdatedServices")]
            ...
            modelBuilder.Entity("POS_System.Domain.Entities.ItemDiscount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ItemDiscountId = 2,
                            Value = 15,
                            Version = new DateTime(2024, 12, 17, 19, 8, 34, 765, DateTimeKind.Utc).AddTicks(8736)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Value = 500,
                            Version = new DateTime(2024, 12, 17, 19, 8, 34, 765, DateTimeKind.Utc).AddTicks(8739)
                        },
                        new
                        {
                            Id = 4,
            ...
            modelBuilder.Entity("POS_System.Domain.Entities.TimeSlot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeVersionId = 1,
                            IsAvailable = true,
                            StartTime = new DateTime(2024, 12, 17, 19, 8, 34, 765, DateTimeKind.Utc).AddTicks(8704)
                        },
                        new
                        {
                            Id = 2,
                            EmployeeVersionId = 1,
                            IsAvailable = true,
                            StartTime = new DateTime(2024, 12, 17, 19, 8, 34, 765, DateTimeKind.Utc).AddTicks(8707)
                        },
                        new
                        {
                            Id = 3,
                            EmployeeVersionId = 2,
                            IsAvailable = false,
                            StartTime = new DateTime(2024, 12, 17, 19, 8, 34, 765, DateTimeKind.Utc).AddTicks(8708)
                        },
                        new
                        {
                            Id = 4,
                            EmployeeVersionId = 3,
                            IsAvailable = true,
                            StartTime = new DateTime(2024, 12, 17, 19, 8, 34, 765, DateTimeKind.Utc).AddTicks(8709)
                        });
                });
